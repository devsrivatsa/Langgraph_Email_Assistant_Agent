...
from triage import triage_input, route_after_triage
...
graph_builder.add_edge("send_email_node", "mark as_read_node") #after sending email, mark as read
...
graph_builder.add_conditional_edges("human_mode", "enter_after_human")
